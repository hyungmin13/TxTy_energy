    ...
    def report(self, i, report_fn, dynamic_params, dynamic_params2, all_params, all_params2, p_batch, v_batch, g_batch, Tx_batch, Ty_batch, b_batch, valid_data, e_batch_key, save_step, model_fns, model_fns2):
        ...
        if save_report:
            ...
            with open(self.c.report_out_dir + "reports.txt", "a") as f:
                f.write(f"{i:<{12}} {Losses[0]:<{12}.{5}} {Losses[1]:<{12}.{5}} {Losses[2]:<{12}.{5}} {Losses[3]:<{12}.{5}} {Losses[5]:<{12}.{5}} "
                        f"{Losses[6]:<{12}.{5}} {Losses[7]:<{12}.{5}} {Losses[8]:<{12}.{5}} {Losses[9]:<{12}.{5}} {Losses[10]:<{12}.{5}} {Losses[11]:<{12}.{5}} {Losses[12]:<{12}.{5}} {Losses[13]:<{12}.{5}} {Losses[14]:<{12}.{5}} {Losses[15]:<{12}.{5}} {Losses[16]:<{12}.{5}} {Losses[17]:<{12}.{5}} {Losses[18]:<{12}.{5}}\n")
            f.close()
        return
